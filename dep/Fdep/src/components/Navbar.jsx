          ...
          <Link className="navbar-brand">
            ...
            <div className='d-flex flex-wrap'>
              <Link className="navbar-brand" to="/">
                <img className="logo-img" src="https://icms-image.slatic.net/images/ims-web/e650d6ca-1841-4646-b0e9-4ddbf2beb731.png" alt="logo" height="50px" />
              </Link>
              ...
              <div className={`collapse navbar-collapse ${isNavbarOpen ? 'show open' : ''}`}>
                <span className='account'>
                  <ul className="navbar-nav d-flex justify-content-evenly align-items-center space">
                    <li>
